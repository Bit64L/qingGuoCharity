...
<div class="container min-height">
    ...
    <div class="row">
        ...
        <br><br>
        <form action="commodityInfoEditSave" method="post" id="commodityInfoEditSave">
            <div class="col-md-5">
                    ...
                    <tr class="row-standard">
                        ...
                        <td class="col-standard2">
                            <textarea class="form-control input" id="intro" name="intro" style="width: 230px;"
                                      name="intro"
                                      value="" rows="5">${commodity.intro}</textarea>
            ...
            <input type="hidden" value="${commodity.image}" name="image">
            ...
            <ul class="button-parallel ">
                <li>
                    <button type="button" class="btn-b right" form="userCenterForm"
                            onclick="location.href='/qingguo/publish/publishManage'">取消
                    </button>
                </li>
                <li>
                    <button class="btn-b right" form="commodityInfoEditSave">下一步</button>
                </li>
            </ul>
